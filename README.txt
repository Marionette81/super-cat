...
4) Pour la première utilisation seulement, il faut initialiser la base de donnée :
    	py -m flask init-db (sous Windows)
	python3.7 -m flask init-db (sous Mac)
...
7) Pour lancer l'application, se placer dans le répertoire de l'application et executer dans l'invite de commande :
    	py -m flask run (sous Windows)
	python3.7 -m flask run (sous Mac)
